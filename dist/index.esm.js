...
function useFullscreen() {
    ...
    var triggerFull = useCallback(function () {
        if (ref.current) {
...
function useInput(init, validator) {
    var _a = useState(init), state = _a[0], setState = _a[1];
...
function useNetwork(onChange) {
    var _a = useState(navigator.onLine), status = _a[0], setStatus = _a[1];
...
function useNotification(title, options) {
    var _this = this;
    var fireNotif = useCallback(function () { return __awaiter(_this, void 0, void 0, function () {
...
function useScroll() {
    var _a = useState({ x: 0, y: 0 }), state = _a[0], setState = _a[1];
...
function useTabs(initTab, allTabs) {
    var _a = useState(initTab), currentIndex = _a[0], setCurrentIndex = _a[1];
    return { currentItem: allTabs[currentIndex], setCurrentItem: setCurrentIndex };
}

var isBrowser = typeof window !== 'undefined';
function useTitle(initTitle) {
    var _a = useState(initTitle), title = _a[0], setTitle = _a[1];
    useEffect(function () {
        if (!isBrowser)
            return;
...
export { useBeforeLeaveMouse, useClick, useFadeIn, useFullscreen, useInput, useNetwork, useNotification, useScroll, useTabs, useTitle, useWillUnmount };
